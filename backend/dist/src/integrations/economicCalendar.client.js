...
export class EconomicCalendarClient {
    ...
    async getUpcomingEvents(startDate, endDate, country, impact) {
        ...
        try {
            ...
            if (impact) {
                filteredEvents = filteredEvents.filter(e => e.impact.toLowerCase() === impact.toLowerCase());
            }
            // Sort by date
     ...
     */
    async fetchFromRealAPI(startDate, endDate, country, impact) {
        try {
...
//# sourceMappingURL=economicCalendar.client.js.map